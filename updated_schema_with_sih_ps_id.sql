-- Updated Supabase Schema for Hackathon Leader Onboarding System with SIH PS ID
...
create table if not exists public.teams (
    ...
    sih_ps_id integer, -- Smart India Hackathon Problem Statement ID
...
for select using (
    exists (
        ...
        and users.email = 'maximusconsultancyservices@gmail.com'
    )
);
